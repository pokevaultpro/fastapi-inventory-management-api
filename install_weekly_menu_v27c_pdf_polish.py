...
def copy_file(src: Path, dst: Path, rel: str) -> None:
    ...
    # Evita shutil.SameFileError quando lo ZIP è stato estratto direttamente nella root progetto.
...
def main() -> None:
    ...
    print("- opzionale: frontend/js/navbar.js se vuoi la route Menu nella navigazione")
