...
PATCH_FILES = [
    ...
    "scripts/force_variable_pricing_model_v20b.py",
    "scripts/migrate_variable_pricing_v20.py",
    "docs/VARIABLE_PRICING_V20.md",
    "docs/VARIABLE_PRICING_V20B_FIX.md",
]
...
def main() -> None:
    ...
    print()
    print("Patch v20b installata.")
    print("Ora esegui:")
    print("python scripts\\force_variable_pricing_model_v20b.py")
    print()
