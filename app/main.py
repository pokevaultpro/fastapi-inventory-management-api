...
from app.routers import (auth, products, favorites, supermarkets, recipes, recipe_items,
                         cart, users, shopping_history, flyer_catalog, profile, recipe_smart, admin, profile_role, admin_bootstrap)
...
from app.routers import admin, cart, shopping_history
...
from app.routers import flyer_offer_admin, flyer_offer_public
from app.routers import admin_cleanup
from app.routers import flyer_offer_page_admin
from app.routers import flyer_offer_image_zip_repair
from app.routers import flyer_offer_product_prices
