...
PATCH_FILES = [
    ...
    "docs/ADMIN_EMERGENCY_DISABLE_FLYER_V26G.md",
]
...
def copy_if_needed(src: Path, dst: Path, rel: str) -> None:
    ...
    if dst.exists():
        backup = dst.with_suffix(dst.suffix + ".bak_disable_flyer_v26g")
...
def main() -> None:
    ...
    print()
    print("Emergency hotfix v26g installato.")
    print("Questo disattiva il widget Offerte volantini per sbloccare admin.html.")
