function renderQuickActions() {
  ...
  const actions = [
    { id: "home", label: "Home", color: "green", icon: "M3 9.75L12 3l9 6.75V21a1 1 0 01-1 1h-5v-6H9v6H4a1 1 0 01-1-1V9.75z" },
    { id: "list", label: "Lista", color: "green", icon: "M5 6h14M5 12h14M5 18h14" },
  ...
  container.innerHTML = actions.map(a => `
    <button class="action-btn-bottom ${a.id === currentPage ? "active" : ""}" data-id="${a.id}" onclick="navigate('${a.id}')" aria-label="${a.label}">
